        ...
        <div class="card-header flex-wrap border-0 pt-6 pb-0">
            <div class="card-title">
                <h3 class="card-label">
                    ...
                    <span class="text-muted pt-2 font-size-sm d-block">@lang( 'admin.sliders_management' ) made easy</span>
                </h3>
            </div>
...
@section('script')
    <script>
        var dataJSONArray = {!! json_encode($sliders) !!};

    </script>
    <script src="{{ asset('assets/admin/js/data-rendering/admin-sliders.js') }}"></script>
@endsection
