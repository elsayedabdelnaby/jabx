                            ...
                            <li class="navi-item">
                                <a href="{{ route('admin.users.index') }}" class="navi-link">
                                    <span class="navi-text">
                                        <span class="label label-xl label-inline label-light-success">@lang( 'admin.sponsors' )</span>
                                    </span>
                                </a>
                            </li>
                            <li class="navi-separator mt-3 opacity-70"></li>
                            <li class="navi-footer py-4">
                                <a class="btn btn-clean font-weight-bold btn-sm" href="{{ route('admin.sponsors.create') }}">
        ...
        <div class="card-header flex-wrap border-0 pt-6 pb-0">
            <div class="card-title">
                <h3 class="card-label">
                    ...
                    <span class="text-muted pt-2 font-size-sm d-block">@lang( 'admin.sponsors_management' ) made easy</span>
                </h3>
            </div>
            <div class="card-toolbar">
                ...
                <!--begin::Button-->
                <a href="{{ route('admin.sponsors.create') }}" class="btn btn-primary font-weight-bolder">
                    <span class="svg-icon svg-icon-md">
...
@section('script')
    <script>
        var dataJSONArray = {!! json_encode($sponsors) !!};

    </script>
    <script src="{{ asset('assets/admin/js/data-rendering/admin-sponsors.js') }}"></script>
@endsection
