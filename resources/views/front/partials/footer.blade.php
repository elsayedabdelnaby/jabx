            ...
            <div class="row">
                    ...
                    <div class="row justify-content-center justify-content-md-start">
                        ...
                        <div class="col-12 pl-xl-5 mt-5 align-self-center">
                            <p class="mb-1 size-17 text-center-v color-light"><i
                                    class="uil uil-map-marker-alt size-20 mr-3 color-primary"></i> 281 1st Avenue, New
                                York</p>
                            <div class="clearfix w-100"></div>
                            <p class="mb-0 size-17 text-center-v color-light"><i
                                    class="uil uil-clock-seven size-20 mr-3 color-primary"></i> Mon - Sat, 8AM to 6PM
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-4 col-lg-3 text-center text-md-left">
                    ...
                    <a href="" class="link size-18 link-primary"
                        data-hover="gaia-office@gaia.design">gaia-office@gaia.design</a>
